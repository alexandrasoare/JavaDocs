...
public class BehaviourParameterisation {
    ...
    public static void main(String[] args) {
        ...
        // print apple color
         prettyPrintApple(inventory, new ColorPrinter());

        // print apple weight
        prettyPrintApple(inventory, new WeightPrinter());
    }
...
class ColorPrinter implements Printer<Apple> {
...
class WeightPrinter implements Printer<Apple> {
